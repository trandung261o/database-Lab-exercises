...
ALTER TABLE student ADD CONSTRAINT student_chk_age CHECK( (DATE_PART('year', current_date) - DATE_PART('year', dob)) BETWEEN 18 AND 10000);
ALTER TABLE lecturer ADD CONSTRAINT lecturer_chk_age CHECK( (DATE_PART('year', current_date) - DATE_PART('year', dob)) BETWEEN 22 AND 10000);
